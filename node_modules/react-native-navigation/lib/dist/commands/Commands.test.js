...
describe('Commands', () => {
    ...
    beforeEach(() => {
        ...
        uut = new Commands_1.Commands(mockCommandsSender, new LayoutTreeParser_1.LayoutTreeParser(), new LayoutTreeCrawler_1.LayoutTreeCrawler(new UniqueIdProvider_mock_1.UniqueIdProvider(), store));
    });
    describe('setRoot', () => {
